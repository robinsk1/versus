# RailsAdmin config file. Generated on October 13, 2013 17:20
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Versus', 'Admin']
  ...
  # config.excluded_models = ['Comment', 'Proposal', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Comment', 'Proposal', 'User']
